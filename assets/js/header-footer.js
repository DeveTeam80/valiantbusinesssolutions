                        ...
                        <div class=header-left>
                            <div class=main-logo-box>
                                <a href="https://valiantbusinesssolutions.com">
                                    <img src=assets/images/logo/vbs-nav-logo.png class=nav-logo alt="Awesome Logo">
                                </a>
                            </div>
                                ...
                                <nav class="main-menu style1 navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id=navbarSupportedContent>
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class=dropdown><a href="vbsjob"><span>Recruitment</span></a>
                                            </li>
                        ...
                        <div class="row text-right-rtl">
                            ...
                            <div class="col-xl-2 col-lg-6 col-md-7 col-sm-12">
                                <div class="single-footer-widget footer-nav">
                                    ...
                                    <div class="footer-widget-links">
                                        <ul class="float-left left">
                                            <li><a href="vbsjob">Recruitment</a></li>
                            ...
                            <div class="col-lg-6">
                                <div class="bottom-inner">
                                    <div class="copyright text-left">
                                        <p>Copyright © 2023 Valiant Business Soultions All
                                            Rights Reserved.</p>
                                    </div>
                                </div>
                            </div>
